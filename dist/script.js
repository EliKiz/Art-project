...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn', 3000); // sliders('.main-slider-item', 'vertical', '', '', 3000);
});
...
var modals = function modals() {
  ...
  function showModals(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        Object(_calcScroll__WEBPACK_IMPORTED_MODULE_1__["modifyBody"])("hidden", scroll); // document.body.style.overflow = "hidden";
    ...
    close.addEventListener('click', function () {
      ...
      Object(_calcScroll__WEBPACK_IMPORTED_MODULE_1__["modifyBody"])('', 0); // document.body.style.overflow = '';
  ...
  function showModalsByTime(selector, time) {
    setTimeout(function () {
      var display; // Проверяем модалки на стили 
  ...
  showModals('.button-order', '.popup-design', '.popup-design .popup-close');
  ...
  openByScroll('.fixed-gift'); // showModals('.popup_engineer_btn', '.popup_engineer', '.popup_engineer .popup_close');
...
var sliders = function sliders(slides, dir, prev, next, switchingTime) {
  var slideIndex = 1,
      paused = false;
  ...
  activateAnimation(); // события на мыш 
