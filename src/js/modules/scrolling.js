const scrolling = (upSelector) => { 
    ...
    //                 // кол-во пикселей от верха элемента до верхней точки видимого элемента 
    //             let heigghtTop = document.documentElement.scrollTop,
    //                 // часть адресной строки 
    //                 hash = this.hash,
    //                 // верхняя граница элем к которому скроллим
    ...
    //                     r = (toBlock < 0 ? Math.max(heigghtTop - progress/speed, heigghtTop + toBlock) : 
    //                     Math.min(heigghtTop + progress/speed, heigghtTop + toBlock));
    //                     // Прокрутка документа до указанных координат.
    //                     document.documentElement.scrollTo(0, r);
    //                     // Условие на остановку анимации
    //                     if(r != heigghtTop + toBlock) { 
    //                         requestAnimationFrame(step);
    //                     }else { 
